...
/decl/hierarchy/outfit/job/dreyfus/prostitute
	name = OUTFIT_JOB_NAME("Prostitute")
	l_ear = /obj/item/device/radio/headset
	uniform = /obj/item/clothing/under/rank/prostitute
	shoes = /obj/item/clothing/shoes/dress
	gloves = /obj/item/clothing/gloves/color/evening
	r_pocket = /obj/item/weapon/lipstick/random
	id_type = /obj/item/weapon/card/id/dreyfus/civilian/employe
	pda_type = /obj/item/device/pda/lawyer
