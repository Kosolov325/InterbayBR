...
/decl/hierarchy/outfit/count
	name = OUTFIT_JOB_NAME("Count")
...
/decl/hierarchy/outfit/countsoldiers
	name = "Count Soldiers"
	head = /obj/item/clothing/head/helmet/siege
	...
	mask = /obj/item/clothing/mask/gas
	gloves = /obj/item/clothing/gloves/thick/swat/combat
	l_hand = /obj/item/weapon/gun/projectile/shotgun/pump/boltaction/shitty/bayonet
	r_hand = /obj/item/weapon/melee/classic_baton
	flags = OUTFIT_NO_SURVIVAL_GEAR
...
/decl/hierarchy/outfit/job/security/bodyguard
	name = OUTFIT_JOB_NAME("Magistrate Bodyguard")
	uniform = /obj/item/clothing/under/syndicate/soldier
	shoes = /obj/item/clothing/shoes/jackboots
	suit = /obj/item/clothing/suit/armor/vest/cerberus
	belt = null
	l_hand = /obj/item/weapon/material/barbarian
	r_pocket = /obj/item/weapon/handcuffs
	gloves = /obj/item/clothing/gloves/thick/combat
	head = /obj/item/clothing/head/helmet/bodyguard
	id_type = /obj/item/weapon/card/id/dreyfus/gold
	pda_type = /obj/item/device/pda/security
	pda_slot = slot_l_store //So they don't lose their PDA.
...
/decl/hierarchy/outfit/job/dreyfus/magikid
	name = OUTFIT_JOB_NAME("Magistrate Kid")
	uniform = /obj/item/clothing/under/succ_jumpsuit
	shoes = /obj/item/clothing/shoes/child_shoes
	id = /obj/item/weapon/card/id/dreyfus/gold

/decl/hierarchy/outfit/job/dealer
	name = OUTFIT_JOB_NAME("Dealer")
	uniform = /obj/item/clothing/under/rank/internalaffairs/plain/nt
	shoes = /obj/item/clothing/shoes/black
	suit = /obj/item/clothing/suit/leathercoat
	r_pocket = /obj/item/weapon/material/butterfly/switchblade
	l_hand = /obj/item/weapon/storage/briefcase/drugs
	id_type = /obj/item/weapon/card/id/dreyfus/sec
	glasses = /obj/item/clothing/glasses/sunglasses
	pda_type = /obj/item/device/pda/security
	pda_slot = slot_l_store