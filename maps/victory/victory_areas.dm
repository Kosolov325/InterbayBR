...
/area/turbolift/main1
	name = "Station level One"
	lift_announce_str = "Arriving at the station level, main hallway."

/area/turbolift/main2
	name = "Station level Two"
	lift_announce_str = "Arriving at the station level, main hallway."

/area/turbolift/main3
	name = "Station level Three"
	lift_announce_str = "Arriving at the station level, main hallway."

/area/turbolift/main4
	name = "Station level Four"
	lift_announce_str = "Arriving at the station level, main hallway."
