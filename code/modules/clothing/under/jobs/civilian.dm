...
/obj/item/clothing/under/rank/prostitute
	desc = "It looks like it could use some more flair."
	name = "Fancy dress"
	icon_state = "prostitute"
	item_state = "prostitute"
	worn_state = "prostitute"
...
/obj/item/clothing/under/succ_jumpsuit
	name = "noble jumpsuit"
	desc = "Fitted just for kids."
	icon_state = "child_magi"
	can_be_worn_by_child = TRUE
	child_exclusive = TRUE
	armor = list(melee = 10, bullet = 0, laser = 0,energy = 0, bomb = 0, bio = 0, rad = 0)
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS