...
/decl/emote/audible/laugh/do_emote(var/mob/living/carbon/human/user)
	...
	if(user.isMonkey())
		...
		if(user.noble == TRUE)
			emotesound = "sound/voice/emotes/noblelaugh[rand(1,7)].ogg"
			if(user.retard == TRUE)
				emotesound = "sound/voice/emotes/stupidlaugh[rand(1,4)].ogg"
		else
...
/decl/emote/audible/giggle/do_emote(var/mob/living/carbon/human/user)
	...
	if(user.isMonkey())
		...
		emotesound = "sound/voice/emotes/male_laugh[rand(2,3)].ogg"
