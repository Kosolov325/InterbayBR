...
/obj/machinery/vending/onion
	name = "Contraband Vendor"
	desc = "Get anything for you shady needs."
	icon_state = "onion"
	icon_deny = "onion-deny"
	products = list(/obj/item/weapon/reagent_containers/syringe/drugs = 3,/obj/item/weapon/material/butterfly/switchblade = 5, /obj/item/weapon/gun/projectile/pistol/shitty = 4, /obj/item/weapon/gun/projectile/shotgun/doublebarrel/sawn = 2, /obj/item/weapon/grenade/frag/shell = 4, /obj/item/weapon/handcuffs/cheap = 10)
	prices = list(/obj/item/weapon/reagent_containers/syringe/drugs = 18,
	/obj/item/weapon/material/butterfly/switchblade = 10,
	/obj/item/weapon/gun/projectile/pistol/shitty = 130,
	/obj/item/weapon/gun/projectile/shotgun/doublebarrel/sawn = 165,
	/obj/item/weapon/grenade/frag/shell = 80,
	/obj/item/weapon/handcuffs/cheap = 20,
	)
